...
public:
     ...
     *
     * @param testedHeader [in] Input header used to generate the mock
     * @param testedSource [in] Generated mock
     ...
     *
     * @param testedHeader [in] Input header used to generate the expectation helper
     * @param testedSource [in] Generated expectation helper
     * @return @c true if the compilation was successful, @c false otherwise
     */
