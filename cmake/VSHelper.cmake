...
function( generate_groups BASE_DIR CURR_DIR )
    ...
    source_group( "Source Files\\${GROUP_NAME}" REGULAR_EXPRESSION ${BASE_DIR}/${CURR_DIR}.*\\.\(cpp\|c\) )
    source_group( "Header Files\\${GROUP_NAME}" REGULAR_EXPRESSION ${BASE_DIR}/${CURR_DIR}.*\\.\(hpp\|h\) )
